...
\begin{figure}[h!]
	...
	\end{tikzpicture}
\end{figure}
I-Glied mit Totzeit gegengekoppelt \formelbuch{109} hat
\[
	G_0(j\omega) = \frac{K_I}{j\omega}e^{-j\omega T_t},
\]
\begin{itemize}
...
\begin{figure}[h!]
	...
	\end{tikzpicture}
\end{figure}
Zwei I-Glieder gegengekoppelt \formelbuch{111} hat
\[
	G_0(j\omega) = \frac{K_1 K_2}{(j\omega)^2},
\]
\begin{itemize}
...
%% TODO: find a better picture or complete tikz
\iffalse
\begin{figure}[h!]
	\centering
	...
	\begin{tikzpicture}
		...
		\foreach \scale / \color / \domain in {%
			1.86/red!50!gray/1.8:{1.3*pi},%
			2.3/orange!50!gray/2:{1.2*pi}%
		}{
			\draw[draw = \color, ultra thick, domain = \domain, samples = 40] plot
