\section{Gegenkopplung und Stabilität \formelbuch{107}}
	\subsection{LTI-Grundglieder}	
		\begin{longtable}{|c|c|l|}
        	...
        	%P-Glied
        	P & \parbox[c][2cm]{3cm}{\input{./tikzBilder/PGlied}}
			&
			\begin{tabular}{lll}
				$y = Ku$ 		& 							& \\
				$u=1(t)$ 		& $y=K 1(t)$ 				& \\
			...
			& 
			& 
			\parbox[c]{3cm}{\input{./tikzBilder/PGliedNyquist}} \quad
			\parbox[c]{6cm}{\input{./tikzBilder/PGliedBode}}			 
	        \\
			\specialrule{2pt}{0pt}{0pt}
			
			
			%I-Glied
			I & \parbox[c][2cm]{3cm}{\input{./tikzBilder/IGlied}}
			&
			\begin{tabular}{lll}
				$\dot{y} = Ku$ 					& 										& \\
				$u=1(t)$ 						& $y=K t$ 								& \\
			...
			& 
			&
			\parbox[c]{3cm}{\input{./tikzBilder/IGliedNyquist}}
			\parbox[c]{6cm}{\input{./tikzBilder/IGliedBode}} 
	        \\
			\specialrule{2pt}{0pt}{0pt}
			
			
			%D-Glied
			D & \parbox[c][2cm]{3cm}{\input{./tikzBilder/DGlied}}
			&
			\begin{tabular}{lll}
				$y = K\dot{u}$					&										& \\
				$u=1(t)$						& $y=K \delta (t)$						& \\
			...
			&			
			&
			\parbox[c]{3cm}{\input{./tikzBilder/DGliedNyquist}}
			\parbox[c]{6cm}{\input{./tikzBilder/DGliedBode}} 
	        \\
			\specialrule{2pt}{0pt}{0pt}
			
			
			%PT1_Glied
			$PT_1$ & \parbox[c][2cm]{3cm}{\input{./tikzBilder/PT1Glied}}
			&
			\begin{tabular}{lll}
				$T\dot{y}+y=Ku$							& $y(0)=0$									& \\
			...
			&
			&
			\parbox[c]{3.7cm}{\input{./tikzBilder/PT1GliedNyquist}}
			\parbox[c]{6cm}{\input{./tikzBilder/PT1GliedBode}}
	        \\
			\specialrule{2pt}{0pt}{0pt}
			...
			&
			& 
			\parbox[c]{3cm}{\input{./tikzBilder/TtGliedNyquist}}
			\parbox[c]{6cm}{\input{./tikzBilder/TtGliedBode}}
	        \\
			\specialrule{2pt}{0pt}{0pt}
        \end{longtable}
