...
\begin{longtable}{|l|l|ll|ll|}
	...
	\\ \hline
		...
		$\alpha e^{j \beta}$ &
		\parbox[c][1cm]{1cm}{\includegraphics[width=1cm]{./bilder/bode-approx-konst.png}} &
	...
	\\ \hline
		Pol im Ursprung &
		$\frac{\alpha}{s}$ &
		\parbox[c][1cm]{1cm}{\includegraphics[width=1cm]{./bilder/bode-approx-ampl-tp-ord1.png}} & 
		\begin{tabular}{l}
	...
	\\ \hline
		...
		$\alpha s$ &
		\parbox[c][1cm]{1cm}{\includegraphics[width=1cm]{./bilder/bode-approx-ampl-hp-ord1.png}} & 
		\begin{tabular}{l}
			Lineare Steigung: $+20 dB/Dek.$ \\
	...
	\\ \hline	
		Reeller Pol &
		$\frac{1}{s + \alpha}$ &
		\parbox[c][1cm]{1cm}{\includegraphics[width=1cm]{./bilder/bode-approx-ampl-4.png}} &
		\begin{tabular}{ll}
			$\omega < \alpha$: & Konstant $-20 \log \alpha$  \\
			$\omega > \alpha$: & $-20dB/Dek.$
		\end{tabular} &
		\parbox[c][1cm]{1cm}{\includegraphics[width=1cm]{./bilder/bode-approx-phase-4.png}} &
		\begin{tabular}{ll}
